    ...
    <div class="py-4 px-6 bg-white w-full flex justify-between items-center sticky top-0 left-0 z-30 transition-all">
        <div class="left-item flex">
            <button id="toggle-sidebar"
                class="flex px-2 py-2 text-[#161519] rounded-lg mr-4 border focus:outline-none hover:bg-[#12294A] hover:border-none hover:text-white">
        ...
        <div class="right-item flex">
            ...
            <div
                class="mx-2 px-2 py-2 rounded-lg text-[#161519] cursor-pointer border border-gray-200 items-center hover:bg-[#12294A] hover:border-none hover:text-white">
