<x-layout>
    ...
    <h1 class="text-2xl font-semibold text-gray-800">Project Summary</h1>

    <div class="elementor-column flex my-6 gap-3 xs:flex-col sm:flex-col md:flex-row">
        <div
            class="elementor-element group flex flex-col bg-[#4466AE] text-white w-52 hover:w-56 transition-all duration-300 rounded-2xl relative">
            <div class="flex items-center justify-center icon bg-[#6D78B7] w-10 h-10 my-6 ml-6 rounded-lg">
                    ...
                    <span
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="1.5" d="m18 8l4 4m0 0l-4 4m4-4H2" />
                        </svg>
                    </span>
                </div>
            </div>
        ...
        <div
            class="elementor-element group flex flex-col bg-[#A63FB0] text-white w-52 hover:w-56 transition-all duration-300 rounded-2xl relative">
            <div class="flex items-center justify-center icon bg-[#B665C4] w-10 h-10 my-6 ml-6 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="currentColor"
        ...
        <div
            class="elementor-element group flex flex-col bg-[#FC844B] text-white w-52 hover:w-56 transition-all duration-300 rounded-2xl relative">
            <div class="flex items-center justify-center icon bg-[#FEA680] w-10 h-10 my-6 ml-6 rounded-lg">
