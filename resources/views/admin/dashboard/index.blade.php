<x-admin.layout>
    <div class="elementor-section flex flex-col m-8 p-6 bg-white rounded-xl">
        <h1 class="font-karla text-2xl font-semibold text-[#181A2A]">Dashboard</h1>
        <p class="font-karla text-sm text-gray-400 mr-2">Track your sales and performance of your strategy
        </p>

        <div class="elementor-column flex my-6 gap-3 xs:flex-col sm:flex-col md:flex-row">
            <div
                class="elementor-element group flex flex-col bg-[#D3E4E0] text-[#181A2A] w-52 hover:w-56 transition-all duration-300 rounded-2xl relative">
                <div class="flex items-center justify-center icon bg-[#c8d7d5] w-10 h-10 my-6 ml-6 rounded-lg">
                ...
                <div class="titlecard flex flex-col my-6 ml-6 gap-2">
                    <h2 class="font-karla text-3xl font-semibold text-[#181A2A]">{{ $categoryCount }}</h2>
                    <div class="flex flex-row justify-between">
                        <p class="font-karla text-sm text-[#181A2A] font-semibold w-10">Completed Category</p>
            ...
            <div
                class="elementor-element group flex flex-col bg-[#D7F23A] text-[#181A2A] w-52 hover:w-56 transition-all duration-300 rounded-2xl relative">
                <div class="flex items-center justify-center icon bg-[#bed539] w-10 h-10 my-6 ml-6 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="currentColor"
                ...
                <div class="titlecard flex flex-col my-6 ml-6 gap-2">
                    <h2 class="font-karla text-3xl font-semibold text-[#181A2A]">{{ $productCount }}</h2>
                    <div class="flex flex-row justify-between">
                        <p class="font-karla text-sm text-[#181A2A] font-semibold w-10">Product Show</p>
            ...
            <div
                class="elementor-element group flex flex-col bg-[#BAB0EF] text-[#181A2A] w-52 hover:w-56 transition-all duration-300 rounded-2xl relative">
                <div class="flex items-center justify-center icon bg-[#a299d0] w-10 h-10 my-6 ml-6 rounded-lg">
                ...
                <div class="titlecard flex flex-col my-6 ml-6 gap-2">
                    <h2 class="font-karla text-3xl font-semibold text-[#181A2A]">{{ $transactionCount }}</h2>
                    <div class="flex flex-row justify-between">
                        <p class="font-karla text-sm text-[#181A2A] font-semibold w-10">Success Transactions</p>
