            ...
            <div class="flex w-96 h-[460px]">
                <div class="flex flex-col justify-center items-center border shadow-lg rounded-3xl bg-white">
                    ...
                    <div class="flex flex-col mt-4 mb-6 items-center">
                        <h3 class="font-sans font-semibold text-2xl text-[#12294A]">Registration</h3>
                        <p class="font-sans text-sm text-[#12294A] mx-16 text-center mt-0.5">Create an account to
                            access to your
                            dashboard,
                            setting and
                            projects.
                    ...
                    <form action="{{ route('store') }}" method="POST">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="text-center">
                                <span class="font-sans text-sm text-gray-500">Have an account? <a
