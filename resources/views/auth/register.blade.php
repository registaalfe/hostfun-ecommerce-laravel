            ...
            <div class="flex w-96 h-[460px]">
                <div class="flex flex-col justify-center items-center border shadow-lg rounded-3xl bg-white">
                    ...
                    <div class="flex flex-col mt-4 mb-6 items-center">
                        <h3 class="font-karla font-semibold text-3xl text-[#12294A]">Registration</h3>
                        <p class="font-karla text-sm text-[#12294A] mx-16 text-center mt-1">Create an account to
                            access to your
                            dashboard,
                            setting and
                            projects.
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="form-group flex flex-col w-80 gap-1">
                                <div
                                    ...
                                    <input
                                        class="font-karla w-full outline-none rounded-md px-2 bg-[#EFF2F6] placeholder:text-gray-500 sm:text-sm sm:leading-6"
                            ...
                            <div class="text-center">
                                <span class="font-karla text-sm text-gray-500">Have an account? <a
