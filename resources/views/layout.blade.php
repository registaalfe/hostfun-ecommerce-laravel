            ...
            <div role="dialog" aria-labelledby="nav-label" class="topnav__menu xs:px-12 xs:z-[9999999] xs:bg-[#12294A] xs:fixed xs:inset-0 sm:px-12 sm:z-[9999999] sm:bg-[#12294A] sm:fixed sm:inset-0 md:px-12 md:z-[9999999] md:bg-[#12294A] md:fixed md:inset-0 lg:self-center xl:self-center">
                ...
                <ul class="topnav__links flex gap-10 xs:gap-4 xs:flex-col sm:gap-4 sm:flex-col md:gap-4 md:flex-col lg:self-center xl:self-center">
                    <li class="topnav__item">
                        <a href="#" class="topnav__link text-[#161519] text-base font-light hover:text-[#525252] xs:text-lg xs:text-left xs:text-white sm:text-lg sm:text-white sm:text-left md:text-white md:text-left lg:font-medium xl:font-medium">Home</a>
                    </li>
                    <li class="topnav__item">
                        <a href="#" class="topnav__link text-[#161519] text-base font-light hover:text-[#525252] xs:text-lg xs:text-left xs:text-white sm:text-lg sm:text-white sm:text-left md:text-white md:text-left lg:font-medium xl:font-medium">Hosting</a>
                    </li>
                    <li class="topnav__item">
                        <a href="#" class="topnav__link text-[#161519] text-base font-light hover:text-[#525252] xs:text-lg xs:text-left xs:text-white sm:text-lg sm:text-white sm:text-left md:text-white md:text-left lg:font-medium xl:font-medium">Domain</a>
                    </li>
                    <li class="topnav__item">
                        <a href="#" class="topnav__link text-[#161519] text-base font-light hover:text-[#525252] xs:text-lg xs:text-left xs:text-white sm:text-lg sm:text-white sm:text-left md:text-white md:text-left lg:font-medium xl:font-medium">Contact</a>
                    </li>
                </ul>
