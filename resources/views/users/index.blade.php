...
<section class="elementor-section elementor-top-section relative flex bg-[#F5F5F5] min-h-full">
    <div class="elementor-container flex container mx-auto min-h-full min-w-full justify-center px-28 py-10 my-14 xs:flex-col xs:px-10 xs:mx-0 xs:my-10 xs:py-5 sm:flex-col sm:px-10 sm:mx-0 sm:my-10 sm:py-5 md:flex-col md:px-20 md:mx-0 md:my-10 md:py-5">
...
<section class="elementor-section elementor-top-section relative flex bg-[#12294A] min-h-full justify-self-auto">
    <div class="elementor-container flex pl-20 pr-28 py-10 my-10 xs:flex-col xs:px-10 xs:mx-0 xs:my-10 xs:py-5 sm:flex-col sm:px-10 sm:mx-0 sm:my-10 sm:py-5 md:px-2">
        <div class="elementor-column flex flex-col w-3/6 p-5 border-r-[1px] border-[#FFFFFF14] xs:w-full xs:border-none xs:p-0 sm:w-full sm:border-none sm:px-0 md:px-8">
            <div class="elementor-element title mb-5 xs:mb-0 sm:mb-0 md:mb-0">
                <h2 class="heading text-4xl font-bold text-white xs:w-[90%] xs:text-3xl sm:text-3xl">End-to-End Hosting Solutions for Your Site's</h2>
            </div>
            <div class="elementor-element btn-contact mt-5 xs:mt-8 sm:mt-8">
                <a href="#" class="signup-button flex text-base text-center font-bold rounded-full mb-16 text-[#12294A] bg-[#F5F5F5] h-[48px] py-0 px-6 w-fit justify-center items-center xs:w-full xs:mb-8 sm:w-full sm:mb-8">Contact Us</a>
            </div>
        </div>
        ...
        <div class="elementor-column w-3/6 accordion flex flex-col px-5 xs:w-full xs:px-0 sm:w-full sm:px-0">
            <div class="elementor-element accordion-item relative">
                ...
                <label for="accordion-1" class="accordion-button flex flex-row justify-between py-3 px-5 cursor-pointer items-center xs:px-0 xs:py-2 sm:px-0 sm:py-2 md:py-2 after:absolute after:content-['+'] after:right-5 after:text-2xl after:text-white peer-checked:after:transform peer-checked:after:rotate-45 after:duration-300">
                ...
                <div class="element-widget-container accordion-collapse h-0 overflow-hidden transition ease-in-out peer-checked:h-full">
                    ...
                    ">
                        <p class="text-base text-[#FFFFFF82] xs:text-sm sm:text-sm">Advertise your brand to large audience through our talents social media.</p>
                    </div>
                </div>
            </div>
            <div class="elementor-element accordion-item relative">
                <input type="checkbox" id="accordion-2" class="accordion-checkbox appearance-none peer">
                <label for="accordion-2" class="accordion-button flex flex-row justify-between py-3 px-5 cursor-pointer items-center xs:px-0 sm:px-0 after:absolute after:content-['+'] after:right-5 after:text-xl after:text-white peer-checked:after:transform peer-checked:after:rotate-45 after:duration-300">
                    <h4 class="heading text-xl font-bold text-white">Audit & Technial Support</h4>
                </label>
                <div class="element-widget-container accordion-collapse h-0 overflow-hidden transition ease-in-out peer-checked:h-full">
                    <div class="accordion-body px-5 py-1 xs:p-0 xs:my-2 sm:p-0 sm:my-2
                    ">
                        <p class="text-base text-[#FFFFFF82] xs:text-sm sm:text-sm">Helped clients with complex technical issues, fixing problems quickly to keep their systems running smoothly.</p>
                    </div>
                </div>
            </div>
            <div class="elementor-element accordion-item relative">
                <input type="checkbox" id="accordion-3" class="accordion-checkbox appearance-none peer">
                <label for="accordion-3" class="accordion-button flex flex-row justify-between py-3 px-5 cursor-pointer items-center xs:px-0 sm:px-0 after:absolute after:content-['+'] after:right-5 after:text-2xl after:text-white peer-checked:after:transform peer-checked:after:rotate-45 after:duration-300">
                    <h4 class="heading text-xl font-bold text-white">Manual & Automated QA</h4>
                </label>
                <div class="element-widget-container accordion-collapse h-0 overflow-hidden transition ease-in-out peer-checked:h-full">
                    <div class="accordion-body px-5 py-1 xs:p-0 xs:my-2 sm:p-0 sm:my-2
                    ">
                        <p class="text-base text-[#FFFFFF82] xs:text-sm sm:text-sm">Participated in the design and maintenance of automated test frameworks, enhancing the efficiency and reliability of automated QA processes.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="elementor-section elementor-top-section flex bg-[#F5F5F5] min-h-full">
    <div class="elementor-container flex flex-col container mx-auto min-h-full min-w-full justify-center px-28 my-10 py-10 gap-16 xs:px-10 xs:mx-0 xs:my-10 xs:py-5 xs:gap-10 sm:px-10 sm:mx-0 sm:my-10 sm:py-5 sm:gap-10 md:px-20 md:mx-0 md:my-10 md:py-5 md:gap-10">
...
<section class="elementor-section elementor-top-section container mx-auto relative flex bg-[#12294A] min-w-full min-h-full">
    <div class="elementor-container relative min-w-full text-center py-[100px]">
        <div class="elementor-column flex flex-col items-center">
            <div class="elementor-element flex flex-col items-center">
                <p class="richtext leading-7 text-lg text-white pb-4 xs:text-sm sm:text-sm md:text-base">Still Not Sure What To Get?</p>
...
<footer class="elementor-section elementor-top-section relative flex flex-col bg-[#F5F5F5] min-h-full">
    <div class="elementor-container flex container mx-auto max-w-5xl text-center px-0 pb-16 xs:px-10 sm:px-10 md:px-20 lg:px-20">
        <div class="footer-content flex justify-between w-full text-left pt-24 xs:flex-col xs:gap-4 sm:flex-col sm:gap-4 md:flex-col md:gap-4">
            <div class="left-footer flex flex-col xs:self-center xs:w-full sm:self-center sm:w-full md:self-center md:w-full">
                ...
                <div class="footer-tagline xs:self-center sm:self-center md:self-center">
                    <p class="richtext leading-7 text-base xs:text-sm xs:text-center xs:mb-2 sm:text-sm sm:text-center sm:mb-2 md:text-center md:mb-2">Partnership@hostfun.com</p>
                    <p class="richtext leading-7 text-base xs:text-sm xs:text-center xs:mb-2 sm:text-sm sm:text-center sm:mb-2 md:text-center md:mb-2">Araya, Malang Regency</p>
                    <p class="richtext leading-7 text-base xs:text-sm xs:text-center xs:mb-2 sm:text-sm sm:text-center sm:mb-2 md:text-center md:mb-2">East Java, INA 65152</p>
                </div>
                <div class="footer-socmed flex gap-2 pt-8 justify-center overflow-hidden xs:hidden sm:hidden md:hidden">
            ...
            <div class="right-footer flex flex-col gap-2 w-[25%] xs:w-full sm:w-full md:w-full">
                <div class="menu-container xs:self-center xs:text-center xs:w-full sm:self-center sm:w-full sm:text-center md:self-center md:w-full md:text-center">
                    <ul class="menu-secondary flex flex-col gap-4">
                        <li class="px-2 pb-1">
                            <a class="richtext leading-7 text-base text-[#020b1f] xs:text-sm sm:text-sm" href="#">Home</a>
                        </li>
                        <li class="px-2 pb-1">
                            <a class="richtext leading-7 text-base text-[#020b1f] xs:text-sm sm:text-sm" href="#">Hosting</a>
                        </li>
                        <li class="px-2 pb-1">
                            <a class="richtext leading-7 text-base text-[#020b1f] xs:text-sm sm:text-sm" href="#">Domain</a>
                        </li>
                        <li class="px-2 pb-1">
                            <a class="richtext leading-7 text-base text-[#020b1f] xs:text-sm sm:text-sm" href="#">Contact</a>
                        </li>
                    </ul>
                </div>
