            ...
            <div
                ...
                <div class="elementor-widget-container md:px-5">
                    ...
                    <p class="richtext my-4 leading-7 text-base xs:text-sm sm:text-sm"><strong>Hostfun.</strong> has
                        partnered with other companies and individuals from multiple industries to ensure that our
                        services
                        are not limited but growing. By helping brands navigate rapidly changing markets and pushing
                        emerging businesses to be heard, we aim to create a solid digital communication that matters.
                    </p>
                </div>
        ...
        <div
            ...
            <div
                ...
                <div class="elementor-element title mb-5 xs:mb-0 sm:mb-0 md:mb-0">
                    <h2 class="heading text-4xl font-bold text-white xs:w-[90%] xs:text-3xl sm:text-3xl">End-to-End
                        Hosting
                ...
                <div
                    ...
                    <div class="flex flex-col mb-5">
                        <h2 class="heading text-3xl font-bold text-[#12294A] mb-5 xs:text-2xl sm:text-2xl md:text-2xl">
                            Faster Loading</h2>
                        <p class="richtext leading-7 text-base xs:text-sm xs:w-72 sm:text-sm sm:w-72 md:w-72">Maximize
                            your
                            website's performance with our Faster Loading Hosting Services. Designed to deliver rapid
                            load
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex flex-col mb-5">
                        ...
                        <p class="richtext leading-7 text-base xs:text-sm xs:w-72 sm:text-sm sm:w-72 md:w-72">Benefit
                            from
                            advanced firewalls, real-time threat monitoring, and robust DDoS protection that work
                            seamlessly
